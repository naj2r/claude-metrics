...
**True-placebo rank (round 2 update — Task C.4)**: with vote #65 (Lebensmittelgesetz) reclassified as a wine-industry rent-seeking comparator (per `progress_2026-04-30_1830_foodbev.md`) rather than an independent placebo, the proper falsification benchmark is the rank of absinthe among the 13 TRUE placebo votes (15 minus #68 treatment minus #65 comparator). **Absinthe ranks #2 of 14** (treatment plus 13 true placebos), permutation-style p = 2/14 ≈ 0.143. The vote that exceeds absinthe is #60 (federal customs tariff law, 25 October 1903, vineyard β = +737, p = 0.328 — direction positive but not statistically significant). A customs tariff has a plausible wine-industry rent-seeking interpretation (tariff protection for domestic wine producers against foreign imports), so #60 may be a third member of the wine-industry-relevant cluster alongside #65 and #68. We retain #60 in the true-placebo set conservatively (its coefficient is not significant; the historical record on #60's wine-industry relevance is weaker than for #65/#68; including it provides a conservative falsification benchmark), but acknowledge the mechanism-relatedness in the paper text. The original round-1 framing was "rank #2 of 15" with #65 in the placebo set; the round-2 framing is "rank #2 of 14 with #65 reclassified out and #60 acknowledged as wine-relevant." Both rank-#2 framings reflect the same underlying empirical fact: there is one non-#68 vote (1903 customs tariff) where wine cantons also voted positively, with the #65 food law also exhibiting the wine-rent-seeking signature but at higher significance. The figure `f03_placebo_distribution.pdf` was updated in round 2 to show only the 13 true placebos in the histogram (#60 still appears as a placebo bar; the caption flags it).
